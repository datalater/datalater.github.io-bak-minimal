---
title: 화폐 예제 실습으로 TDD의 리듬 느껴보기 (feat. TypeScript)
date: 2022-02-11
categories: [TIL]
...
회고한 내용은 [회고 - 화폐 예제 실습으로 TDD의 리듬 느껴보기]({% post_url 2022-02-11-retro-tdd-currency-1 %})에서 볼 수 있습니다.
...
1. 레드(RED) - 실패하는 작은 테스트를 작성한다.
2. 그린(GREEN) - 빨리 테스트가 통과하게끔 만든다.
...
> 스텁 구현은 메서드의 서명부와 (반환값이 있을 경우) 반환 명령만 적는 식으로 해서, 이 메서드를 호출하는 코드가 컴파일 될 수 있도록 껍데기만 만들어두는 것을 뜻한다.
...
- [회고 - 화폐 예제 실습으로 TDD의 리듬 느껴보기]({% post_url 2022-02-11-retro-tdd-currency-1 %})
